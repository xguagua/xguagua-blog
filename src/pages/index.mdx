...
<BaseLayout title="Home">
  ...
  <div style = "text-align: center;">
    <button id = "btn" onclick = "logic()" style = "float: left;font-size: 47px;font-family: KaiTi;display: none;">每日歌单</button>
    <iframe id = "displayMain" style = "display: none;">awa</iframe>
  </div>
  </BaseCard>
</BaseLayout>